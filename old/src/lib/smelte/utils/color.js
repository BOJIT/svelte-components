...
function buildPalette(hex) {
    ...
    return {
        transLight: tinycolor(lightest[50]).toRgbString().replace(')', ', 0.15)'),
        trans: tinycolor(lightest[50]).toRgbString().replace(')', ', 0.7)'),
        transDark: tinycolor(hex).toRgbString().replace(')', ', 0.15)'),
        ...
        ...o(tinycolor.mix(baseDark, baseTriad[4], 15).saturate(80).lighten(65), 'a100'),
        ...o(tinycolor.mix(baseDark, baseTriad[4], 15).saturate(80).lighten(55), 'a200'),
        ...o(tinycolor.mix(baseDark, baseTriad[4], 15).saturate(100).lighten(45), 'a400'),
        ...o(tinycolor.mix(baseDark, baseTriad[4], 15).saturate(100).lighten(40), 'a700')
    };
}

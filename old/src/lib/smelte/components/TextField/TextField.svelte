...
<div class={wClasses}>
    ...
    {#if append}
        <div class={aClasses} on:click={() => dispatch('click-append')} on:keypress={() => {}}>
            <slot name="append">
    ...
    {#if prepend}
        <div class={pClasses} on:click={() => dispatch('click-prepend')} on:keypress={() => {}}>
            <slot name="prepend">
    ...
    <Underline {noUnderline} {outlined} {focused} {error} {success} {color} />
